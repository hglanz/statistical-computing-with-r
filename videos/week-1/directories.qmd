...
<!-- (Almost) one-click reproducibility: Reproducing all the computations required to generate the results of a study should require (almost) nothing other than executing a single Master Script. -->
...
- R Markdown and Quarto ignore this code when knitting! 
...
### 3. Click on your STAT331 R Project to open up RStudio
</br>
### 4. Use `getwd()` to find the **path** to your class directory.
