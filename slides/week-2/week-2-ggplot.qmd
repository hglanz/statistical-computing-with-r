...
+ [PA 2: Using Data Visualization to Find the Penguins](https://posit.cloud/spaces/546280/content/8635027)
...
+ When you want to open R to complete a new assignment for this class, do so by
**double clicking on your .Rproj file** (the blue cube).

+ Make sure you **install** a package before you **load** it!

# Pair Programming

## Let's Talk Pair Programming
...
**Informed Consent**: If you have not already, please complete the [informed consent](https://canvas.calpoly.edu/courses/130201/pages/informed-consent-for-participation) for our research into the pedagogy surrounding pair programming. 
...
How would you make the points be [**on top**]{.underline} of the boxplots?
...
-   Directs the Listener what to type in the Quarto document in Posit Cloud
-   Instructs the Listener what comments to make in the Quarto document to help the group understand the code later
-   Keeps group on task
:::
:::
:::
...
::: {.incremental}
::: {.small}
- the first column (far left) column provides the "template" for making a ggplot
- the third column has advice on creating plots for two continuous variables
- the third column has advice on creating plots for one discrete or one continuous variable
:::
:::
:::
:::
...
::: {.incremental}
::: {.small}
- the fourth column (far right) provides information on adding facets and labels to your plot
- the third column has information on adding themes to your plot (if you have extra time)
:::
:::
:::
:::
...
The partner whose family name starts first alphabetically starts as the Listener! 

They need to do the following:

- Click on the PA1 link in Canvas 
- Log-in to Posit Cloud
<!-- add instructions on how to make the project use collaborative editing -->
- Open the `PA2-ggplot.qmd` file (from the lower right corner)
- Get started! 
...
- Each person will input the answers to these questions in the PA1 Canvas quiz.
- The person who last occupied the role of Listener will download and submit the
`PA-2.qmd` file for the group.
