...
<!-- Fill in based on group Quarto submissions -->
...
- If you used ChatGPT: 
  ...
  + download and attach the `.txt` file containing your **entire** conversation
  with ChatGPT
:::
...
- GPT uses machine learning to predict what words to give you
  ...
  + Meaning, the same question may produce different answers for different 
  people
:::
