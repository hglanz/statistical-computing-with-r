...
4. Start finding exerpts of code you wrote for the Labs or Challenges that fit each learning target. 
:::
...
- The middle column has functions related to "getting components" of dates
- The bottom right corner has functions related to time zones

::: {.fragment}
**On the Back**: 

- The left column has functions related to adding / subtracting "periods" to / 
from dates
- The right column has functions related to creating and using intervals of time
:::
:::
:::
...
- Each person will input the full name of the theif into the PA 5.2 quiz. 
...
- **Introductions to Writing Functions in R**
