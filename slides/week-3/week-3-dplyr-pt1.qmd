...
Today you will use the `dplyr` package to clean some data and then use that
...
## Pair Programming Collaborations

<!-- Add blurb about roles  -->
<!-- Add reminder about multiple abilities -->

<!-- Add blurb about cheatsheet -->
