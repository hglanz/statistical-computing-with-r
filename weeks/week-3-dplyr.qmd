...
-   How to wrangle data using the **dplyr** package in the **tidyverse**
...
<!-- Update with totals from videos -->
...
`r emo::ji("play button")` [Required Video: Learning More about Data Types -- 11 minutes](https://youtu.be/Z7iRJWy5ZJA)

`r emo::ji("play button")` [Required Video: A Bit More on Object Structures -- 8 minutes](https://youtu.be/8EBKGY38MPA)

`r emo::ji("book")` [Required Reading: Tibbles](https://r4ds.had.co.nz/tibbles.html)

## `r emo::ji("check")` Check-in 3.1: Data Structures

**Question 1**

These materials did **not** explicitly discuss the important structure of 
**`data.frames`**. That's because, in essence, a `data.frame` is simply a
special `list` - with a few extra restrictions on the `list` format.
...
`r emo::ji("play button")` [Required Video: Intro to the tidyverse & dplyr -- 8 minutes](https://youtu.be/jgVi2znoHgg)
...
::: columns
::: {.column width="40%"}
`r emo::ji("play button")` [Required Video: `filter()` -- 11 minutes](https://youtu.be/pPI-prhLYqI)

`r emo::ji("play button")` [Required Video: `select()` -- 6 minutes](https://youtu.be/OInnmiccHt8)

`r emo::ji("play button")` [Required Video: `mutate()` -- 9 minutes](https://youtu.be/QWyUnQ2EzPs)

</br> </br>

`r emo::ji("play button")` [Required Video: `arrange()` -- 7 minutes](https://youtu.be/4Qhdc81mpvo)

`r emo::ji("play button")` [Required Video: `summarize()`-- 8 minutes](http://somup.com/crflYibWZw)

`r emo::ji("play button")` [Required Video: `group_by()` -- 6 minutes](http://somup.com/crflqbbWFy)
:::
...
`r emo::ji("play button")` [Required Video: The pipe operator -- 8 minutes](http://somup.com/crflYfbWZD)

`r emo::ji("play button")` [Required Video: Extending the pipe -- 3 minutes](http://somup.com/crflYmbWup)
...
## `r emo::ji("check")` Check-in 3.2: Data Wrangling
