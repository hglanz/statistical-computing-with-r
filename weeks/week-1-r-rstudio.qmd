...
![](images/week-1/r-version.png){fig-alt = "A screenshot of what version of R should appear when you open RStudio. The version reads 'R version 4.4.1 (2024-06-14) -- 'Race for Your Life'."}

If the version **is not** 4.4.1 (like the image above), you need to update your
...
If you would like a video tutorial on installing R, here is one: <https://www.youtube.com/watch?v=YrEe2TLr3MI> (from 0:47 to 1:53)
...
If you would like a video tutorial on installing R, [here is one for Windows (from 1:58 to 2:32)](https://www.youtube.com/watch?v=YrEe2TLr3MI) and [here is one for Mac (2:10 to 3:10)](https://www.youtube.com/watch?v=n8kP7c_QbLA). 
...
### 📖 [Required Reading: A tour of RStudio](https://rladiessydney.org/courses/ryouwithme/01-basicbasics-1/)
...
![The RStudio window will look something like this.](images/Rstudio-important-buttons.png)
