...
If you've never downloaded RStudio before, the link below will navigate you to where you can download RStudio from Posit (the parent company):
...
![](images/typing_R.gif){fig-alt="A video of Hadley Wickham (author of many R packages) pretending to type and saying 'just typing R code'."}
...
![](images/Rstudio-editor-pane-buttons.png)
