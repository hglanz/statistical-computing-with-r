...
The theme of this lesson is good management of your files and data. In part two of this week's coursework you will learn how to identify **folders** and **paths**, use **R Projects**, and create **Quarto documents**.
...
<!-- Insert picture of file storage (331 > Week 1 > Lab > data + analysis w/ R Project) -->
...
::: callout-caution
Your RStudio project **cannot** be in a folder stored on OneDrive or iCloud! Storing your project in this location will cause your code to periodically not run and I cannot help you fix it.

<!-- update video to only use documents -->

<!-- [Here](https://www.youtube.com/watch?v=Ai-HV_7TmL4) is a video showing how you need to set-up your STAT 331 folder and RStudio Project. -->
:::
