...
::: {.column-margin}
{{< video https://youtu.be/wiPjz3yf3bA >}}
:::
...
-   a "Stat 331" folder in your Documents folder, containing **all** your
materials associated with STAT 331
...
I have six total folders in my Documents, one of which is a folder named "STAT
...
PC), so the "full path" to get to my Lab 1 folder would be:
