...
#### Mondays & Wednesdays (from 9:10 - 11:00am)

## Join the server

Join the [Stat 331 Server (https://discord.gg/dMadzkGb)](https://discord.gg/dMadzkGb) to start experimenting with the interface.
...
## `r emo::ji("check")` Check-in 1.5: Discord Server
...
*Usually due Wednesdays at midnight*
...
## `r emo::ji("check")` Check-in 1.1: Syllabus Quiz
...
**Question 4:** You have finished the week's Practice Assignment, and you want
...
**Question 5:** You have been working on Lab 3 for what feels like forever and
...
**Question 6:** You have been getting frustrated with finding an error in your
...
**Question 7** You have been studying for another class, the deadline for Lab 2
