...
semester_dates <- seq(ymd(20250106), ymd(20250323), by = 1)
...
Cal2 <- tibble(date = seq(ymd(20240107), ymd(20240113), by = 1))  |> 
  mutate(mon      = lubridate::month(date, label = T, abbr = F),
         ...
         officehrtime = c(NA, "9:10-11:00am", NA, "9:10-11:00am",  NA, NA, NA)
  )
...
[hglanz\@calpoly.edu](mailto:hglanz@calpoly.edu?subject=Stat%20331/531)

`r fontawesome::fa("building")` Office: Building 25 Office 111
...
**Office Hours** are held in my office (25-111) during the following
times:
...
<!-- | Mondays    | 9:10am - 11:00am    | -->

<!-- | Wednesdays | 9:10am - 11:00am    | -->
...
There is an abundance of free online resources for learning programming and R. Our primary resource will be the text linked above. However,
there is a compilation of various other resources that I can happily endorse. These are listed below.

-   [Custom Text](https://manncz.github.io/stat331-calpoly-text/)
...
Most Tuesdays, you will be given a Practice Activity to complete, to get
...
in-class tentatively during our last class period. More information will
follow.
...
<!-- You will be assigned groups throughout the course and will be expected to work with your -->
...
deduction policy. I will need to manually adjust your grade when you request an extension. You are responsible for double checking your
