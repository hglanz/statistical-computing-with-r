...
-   If you aren't sure how to make a specific plot or how to customize a look over the class text for this week and make use of the [ggplot2 cheatsheet](https://rstudio.github.io/cheatsheets/html/data-visualization.html?_gl=1*1u8zjpq*_ga*MTM4Nzk4ODMyOC4xNzA2NzU3MjEx*_ga_2C0WZ1JHG0*MTcxODkxNjU5Ny43LjAuMTcxODkxNjU5Ny4wLjAuMA).
...
(typing and listening to instructions from the Problem Solver)!
