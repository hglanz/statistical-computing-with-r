...
-   Google and ChatGPT can be your friend! If an error is confusing, copy it
into Google (or ChatGPT) and see what other people are saying. 

-   Just because there is no error message doesn't mean everything went
smoothly! Use the **console** (lower left pane) to check each step and make sure
you have accomplished what you wanted to accomplish.

## Part Zero: Accessing the Practice Activity

<!-- Blurb on how to get to Posit Cloud.  -->
