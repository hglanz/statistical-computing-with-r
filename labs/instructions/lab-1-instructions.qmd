...
## Step 1: Making a Copy from GitHub

You can find the Lab 1 materials in the
[Lab 1 repository on GitHub](https://github.com/atheobold/stat-331-lab-1). When 
you click on the provided link, you will end up on the landing page for the 
repository. 

To make a copy of the project you need to carry out the following 
steps:

1. Click on icon that says ![](images/fork.png){width=15%}, to create your own
...
11. Navigate to the "Lab 1" folder you made in the Week 1 folder of your STAT
331 folder. Once you get there, click "Open".
...
- In the upper right corner you should see a blue R cube with `stat-331-lab-1` written next to it ![](images/new-r-project.png){width=15%},
this tells you that you are working in an R Project (we'll learn more about
these next week).
...
- Every file included in the repository should be listed with a question mark
symbol next to it, that's okay! This just means these files are not currently 
being tracked. 
...
Go back to your browser. I assume you're still viewing the GitHub repo you just
cloned. Refresh the page. You should see all the project files you committed
there. If you click on "commits", you should see one with the message you used,
e.g. "Initialize lab 1". 

## Step 5: Let's get started working with Quarto!

In the Files pane, click on `lab-1.qmd` to open the Quarto file you will be 
working in for Lab 1. 
...
of) the code you want to run and hit <kbd>ctrl</kbd> + <kbd>Enter</kbd> (for PCs) or
<kbd>⌘</kbd> + <kbd>Enter</kbd> (for Macs).
...
Your second code chunk is just as boring as your first, so
let's spice it up!
...
Look up the help documentation for `t.test()` for directions on how your 
inputs should look. Hint: specifically look at the examples at the bottom
for comparing `extra` across groups in the `sleep` dataset.
:::
