...
## Step 1: Accessing Making a Copy from GitHub

You can find the Lab 1 materials in the [Lab 2 repository on GitHub](https://github.com/atheobold/stat-331-lab-2). When you click on the
provided link, you will end up on the landing page for the repository.

We're going to follow the same steps as last week to make your own copy of this
repository:
...
Now that you have a copy of the repository, we need to [commit the files to our repo](https://happygitwithr.com/existing-github-first#stage-and-commit). To do 
