...
You can access the Lab 3 materials through the [Lab 3 assignment on GitHub Classroom](https://classroom.github.com/a/Wd6RcGOb). We're going to follow the same steps as last week to make your own copy of this repository:
...
Use these steps to make a copy of the Lab 3 repository: [List of Steps to Copy the Lab Assignment from GitHub Classroom](https://scribehow.com/shared/RStudio_and_Google_Chrome_Workflow__ATprsf2MTYmuPP86Xna1Eg)
:::

## Step 2: Pushing Your Lab to GitHub

Now that you have a copy of the repository, we need to [commit the files to our repo](https://happygitwithr.com/existing-github-first#stage-and-commit). To do this, follow the steps below:
